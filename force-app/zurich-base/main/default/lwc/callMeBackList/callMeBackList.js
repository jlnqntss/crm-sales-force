...
export default class CallMeBackList extends LightningElement {
    ...
    // Con wire no funciona, comprobación con async y await
    async handleLoad(){
        this.records = await getContactRequestsByCustomerId({whoId : "0037a00001W7OIMAA3"});
    }

    renderedCallback() {
        console.log(
        "🚀 ~ file: callMeBackList.js ~ line 47 ~ CallMeBackList ~ renderedCallback ~ callMeBacks",
        this.callMeBacks
        );
    }
